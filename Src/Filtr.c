...
void Init_MPU(){
	...
	uint8_t data[3]={0b00000001,
				     0b00011000,
				     0b00001000};
	HAL_I2C_Mem_Write(&hi2c3,GYRO,0x6B,1,&power,1,1000);
    HAL_I2C_Mem_Write(&hi2c3,GYRO,0x1A,1,data,3,1000);
    data[0]=0b01111000;
    HAL_I2C_Mem_Write(&hi2c3,GYRO,0x23,1,data,1,1000);

}
void Read_MPU_Gyro(){
	uint8_t data[6]={};
	HAL_I2C_Mem_Read(&hi2c3,GYRO,0x43,1,data,6,1000);
...
void Read_MPU_Accl(){
	uint8_t data[6]={};
	HAL_I2C_Mem_Read(&hi2c3,GYRO,0x3B,1,data,6,1000);
